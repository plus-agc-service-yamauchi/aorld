...
<body>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-9"><a href="./index.php"><img src="img/header_logo.png" alt="ロゴ"></a></div>
            <div class="col-3">
                <p class="text-right">社会福祉法人あーるど
                    <br><a href="https://twitter.com/AORLD_OFFICIAL?ref_src=twsrc%5Etfw&ref_url=http%3A%2F%2Flocalhost%2Fsample_2%2Findex.html"><i class="fab fa-twitter tw"></i></a>&nbsp;&nbsp;<a href="https://www.facebook.com/npoaorldofficial/"><i class="fab fa-facebook-f fb"></i></a></p>
            </div>
        </div>
    </div>
</header>
        ...
        <div class="row align-items-center">
            <div class="col-4">
                ...
                <div class="col-4 text-center">
                    <a href="contact.php"><i class="far fa-envelope fa-2x"></i></a>
                    <br> お問い合わせ
            </div>
            <div class="col-4 text-center">
                <img src="img/header_logo.png" alt="" class="w-50">
                <br>
