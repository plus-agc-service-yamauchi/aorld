...
$Referer_check_domain = "http://aorld.jp/";
...
$require = array('お名前','電話番号','Email','都道府県','お問い合わせ内容');
	...
	<header id="header" class="">
		...
		<div class="bg-gray">
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav">
					<li class="nav-item">
						<a class="nav-link text-white" href="index.html">トップ <span class="sr-only">(現位置)</span></a>
					</li>
					<li class="nav-item">
					...
					<li class="nav-item">
                        <a class="nav-link text-white" href="http://aorld.jp/blog/">求人情報</a>
                    </li>
					<li class="nav-item">
	...
	<div class="container p-5">
		...
		<footer id="footer">
			<div class="row text-center">
				<div class="col-12">
					<h4>社会福祉法人あーるど</h4>
					<p>〒037−0017 青森県五所川原市漆川字鍋掛147-2
                    <br>TEL/FAX <a href="0173-26-1021" class="text-white">0173-26-1021</a></p>
					</div>
					<div class="col-sm-6">
						<p class="mt-4"><a href="contact.html" class="text-white"><i class="far fa-envelope fa-2x"></i></a>
							<br>お問い合わせ</p>
						</div>
						<div class="col-sm-6">
							<p class="mt-4"><img src="img/header_logo.png" alt="" class="w-25">
...
function copyright(){
	echo '<p class="text-center">- 社会福祉法人あーるど -</p>';
}
//----------------------------------------------------------------------
//  関数定義(END)
//----------------------------------------------------------------------
